...
def build_input_from_segments(history: List[List[int]], reply, tokenizer, with_eos=True):
...
def sample_sequence(history: List[List[int]], tokenizer, model, args, current_output=None):
...
def run():
    ...
    parser.add_argument("--model_checkpoint", type=str, default=r"G:\Data\Cdial-GPT1Large")
